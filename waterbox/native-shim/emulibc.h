 ...
 * sources the guest does; here the waterbox allocation/visibility API degrades
 * to plain malloc and no-op attributes. The guest build never sees this file:
 * its include path has miniBox's real emulibc first.
 */
#ifndef _EMULIBC_H
#define _EMULIBC_H
